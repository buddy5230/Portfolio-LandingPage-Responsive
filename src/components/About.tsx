    ...
    <div className="con-about" id="about">
      <div className="about-con">
        ...
        <div className="about-r">
          <h1 className="text-h2">About Me</h1>
          <p className="text-p">
            ...
            API and Responsive Web Design. With my experience and passion for front-end development, I am
            confident that I will be able to do my assigned job well and I am
            ready to learn new knowledge to further develop myself.
          </p>
        </div>
      </div>
    </div>
